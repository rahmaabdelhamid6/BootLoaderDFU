...
#ifndef DFU_USB_BOOTLOADER_HAL_HAL_FLASH_INC_HAL_FLASH_H_
#define DFU_USB_BOOTLOADER_HAL_HAL_FLASH_INC_HAL_FLASH_H_

#define NUM_OF_FLASH_PAGES     256U

#define NUM_OF_FLASH_APP_PAGES_IN_BANK     128U
...
//uint32_t	HAL_FLASH_Write (uint8_t * pui8Data , uint8_t ui8DataSize);
//uint32_t	HAL_FLASH_Read (uint8_t * pui8Data , uint8_t ui8DataSize);


//uint32_t  HAL_FLASH_EraseEntireFlash();
//
//uint32_t HAL_FLASH_ErasePages(uint32_t ui32StartAddress , uint8_t ui8NoOfPages);




#endif /* DFU_USB_BOOTLOADER_HAL_HAL_FLASH_INC_HAL_FLASH_H_ */
